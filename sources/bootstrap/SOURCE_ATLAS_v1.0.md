...
| `process/deltas/2026-06-30-first-contact-preview-and-hook-clarity.md` | delta | First-contact preview path and external-host hook clarity |
...
| `docs/first-contact-preview.md` | guide | Safe local preview ladder before real target integration |
